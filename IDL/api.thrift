...
service ApiService{
    ...
    basic.UserLoginResponse Login(1: basi.UserLoginRequest req) (api.post="/douyin/user/login/")
    ...
    // extra apis - I
    interaction.FavoriteActionResponse FavrotieAction(1: interaction.FavoriteActionRequest req) (api.post="/douyin/favorite/actio/n")
